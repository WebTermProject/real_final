...
<body>
   ...
   <!--메뉴-->
   <button class="free_menu">자유게시판</button>
   <!--각자 페이지에 맞게 수정하기-->
   <ul class="topnav">
      <li><a href="/GYM/front/notice/noticeBoard" title="공지사항 바로가기">공지사항</a></li>
      <li><a class="active" href="/GYM/front/free/freeBoard" title="자유게시판 바로가기">자유게시판</a></li>
      ...
      <!-- 글 쓰기 테이블 -->
   <form name="writeform" action="/GYM/front/free/writeForm" method="post" onsubmit="return check()">
      <div class="side">
         <button onclick="location.href='freeBoard'">글 목록으로 돌아가기</button>
         <input type="submit" value="저장"></input>
      </div>
      <table class="writTr">
         <tr>
            <td class="title">제목</td>
            <td><input type="text" name="title" style="width:100%; height:100%"></input></td>
         </tr>
         <tr>
            <td>작성자</td>
            <td><input type="text" name="writer" style="width:100%; height:100%"></input></td>
         </tr>
         <tr>
            <td class="contents">내용</td>
            <td height="400"><textarea name="contents" style="width:100%; height:100%"></textarea></td>
         </tr>
      </table>
   </form>
   ...
   <script>
      // ----------------------- 자바스크립트 ----------------------- 
      // ----------------------- 아코디언 ----------------------- 
      var acc = document.getElementsByClassName("free_menu");
      var i;
